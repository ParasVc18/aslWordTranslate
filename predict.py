        ...
        for text in textlist:
            ...
            with open(textname, mode = 'r') as t:
                ...
                for i in range(len(numbers),25200):
                    numbers.extend([0.000]) #300 frame fixed
            landmark_frame=[]
            row=0
            for i in range(0,70):
...
def main(input_data_path):
    ...
    # #Media Pipe Instruction Storage
    ...
    #         continue
    #     word=file+'/'
    #     fullfilename=os.listdir(input_data_path)
    #     print(fullfilename)
    #     # Stores the names of all videos in subdirectories
    ...
    #         cmdret=cmd+inputfilen+outputfilen
            #os.system(cmdret)
    #mediapipe end of it's use:
    output_dir=input_data_path
    ...
    txtpath=input_data_path+"result.txt" 
